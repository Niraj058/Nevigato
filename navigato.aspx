<%@ Page Language="C#" AutoEventWireup="true" CodeFile="navigato.aspx.cs" Inherits="navigato" %>
...
<html lang="en">
<head>
<title>Nevigato a Travel Category Bootstrap responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Nevigato Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
			...
			<div class="container banner-drop">
				<div class="header">
					<div class="header-left logo">
						<h1><a href="index.html">Nevigato</a></h1>
					</div>
				...
				<div class="subscribe">
                            Want to know Famous location Around You<asp:Button ID="Button4" runat="server" Text="Click here" OnClick="Button4_Click" />
                        </div>
				...
				<div class="services-right-grids">
					<div class="col-sm-4 services-right-grid">
						...
						<div class="services-icon-info">
                         ...
                         <h5> <asp:Button ID="Button1" runat="server" Text="Hotel" OnClick="Button1_Click" /> </h5>
					...
					<div class="col-sm-4 services-right-grid">
						...
						<div class="services-icon-info">
						<h5> <asp:Button ID="Button2" runat="server" Text="Resort" OnClick="Button2_Click" /> </h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed orci enim, posuere sed tincidunt et.</p>
						</div>
					</div>
				<div>
						...
						<div class="col-md-8 col-sm-8 ggd baner-top big wow fadeInRight animated" data-wow-delay=".5s">
							<a href="images/g3.jpg" class="b-link-stripe b-animate-go  swipebox">
								<div class="gal-spin-effect vertical ">
									<img src="images/vsnice.jpg" alt=" " />
									<div class="gal-text-box">
										<div class="info-gal-con">
											<h4>Nevigator</h4>
											<span class="separator"></span>
											<p>Travel Perfection With the Professionalism of Experts.</p>
											<span class="separator"></span>
...
<!-- //about -->
	<div class="footer">
		<div class="container">
		<h3><a href="index.html">Nevigato</a></h3>
			<p>© 2017 Nevigato. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
			<div class="social-icons animated wow bounceInDown" data-wow-duration="1000ms" data-wow-delay="800ms">
					<ul class="top-links">
						<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						<li><a href="#"><i class="fa fa-twitter"></i></a></li>
